...
switch argument1
{
    ...
    case 1:
        ...
        for (i = 0; i < array_length(clipboard); i++)
            hlp_show_copy_preview((mx * 60), (my * 60), clipboard[i], variable_struct_get(argument0, "image_angle"), x_off, y_off)
    ...
    case 2:
        ...
        for (i = 0; i < array_length(clipboard); i++)
        {
            ...
            var _Ts = variable_struct_get(clipboard[i], "toolStruct")
            rot_data = hlp_rotate_object_data(created_inst_x, created_inst_y, (created_inst_x + clip_entry.x), (created_inst_y + clip_entry.y), variable_struct_get(argument0, "image_angle"), clip_entry.toolStruct, clip_entry, x_off, y_off)
