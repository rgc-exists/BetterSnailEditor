...
variable_struct_set(copy_tool_copy, "placement_script", gml_Script_scr_models_tool_place_model)
variable_struct_set(copy_tool_copy, "deletion_script", gml_Script_scr_models_tool_save_model)
