...
repeat (2)
    file_text_writeln(file)
file_text_write_string(file, "Better Saving")
file_text_writeln(file)
file_text_write_real(file, global.setting_betterSaving)
repeat (2)
    file_text_writeln(file)
file_text_write_string(file, "Custom Editor Playlist")
file_text_writeln(file)
file_text_write_real(file, global.setting_custom_editor_playlist)
repeat (2)
    file_text_writeln(file)
file_text_write_string(file, "Show Hitboxes On Death")
file_text_writeln(file)
file_text_write_real(file, global.setting_show_hitboxes_on_death)
repeat (2)
    file_text_writeln(file)
