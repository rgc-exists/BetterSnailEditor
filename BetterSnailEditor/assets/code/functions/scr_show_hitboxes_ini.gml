...
global.li_collectible_object_names = ["UPWARD GUN", "FORWARD GUN", "DOWNWARD GUN", "AUTO-AIM GUN", "HAT", "COLLECTIBLE HEART", "EXPLORATION POINT", "VICTORY ITEM", "DIALOG FILE", "SMILEY", "SMILEY", "FINISH LINE", "BASKETBALL", "TARGET", "UPLIFTER", "SPEED BOOSTER", "CASHCOW", "CASHCOW", "BASKET", "BUBBLE", "EXPLORATION POINT", "EXPLORATION POINT"];
