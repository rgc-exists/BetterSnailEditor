                ...
                for(var w = 0; w < ds_list_size(global.lvl_wires); w++){
                    ...
                    if(connection.from_obj == from_obj){
                        ...
                        if(ds_list_find_index(clipboard_instances, to_obj) != -1){
                            ds_list_add(global.current_model_wires, [indx, ds_list_find_index(clipboard_instances, to_obj)])
                        }
                    }
                }
            }
...
switch argument1
{
    ...
    case 2:
                ...
                for(var w = 0; w < ds_list_size(global.lvl_wires); w++){
                    ...
                    if(connection.from_obj == from_obj){
                        ...
                        if(ds_list_find_index(li_objects_in_box, to_obj) != -1){
                            ds_list_add(global.current_model_wires, [indx, ds_list_find_index(li_objects_in_box, to_obj)])
                        }
                    }
                }
            }
        ...
        global.current_model = clipboard_model
        global.current_model_wires = global.current_model_wires
